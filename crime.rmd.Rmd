...
The crime rate decreases in Brooklyn (Kings County), Queens (Queens County), and Staten Island (Richmond County) from 2013 to 2019, but fluctuated in Manhattan (New York County) and Bronx (Bronx County).
...
With the increase of crime rate, there seems to be an increasing trend of HIV diagnosis rate overall. In Manhattan, HIV diagnosis declined from 2013 to 2019, but crime rate did not change much.