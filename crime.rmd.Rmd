...
The following graphs show the crime rate in the five boroughs from 2013 to 2019, and the potential relationship between crime rate and HIV diagnoses.
...
Generally speaking, Mahattan has the highest crime rate while Staten Island has the lowest rate. More specifically, the crime rate decreases in Brooklyn (Kings County), Queens (Queens County), and Staten Island (Richmond County) from 2013 to 2019, but fluctuated in Manhattan (New York County) and Bronx (Bronx County).
...
With the increase of crime rate, there seems to be an increasing trend of HIV diagnosis rate overall. However, in Manhattan, HIV diagnosis rate declined from 2013 to 2019, but crime rate did not change much.
