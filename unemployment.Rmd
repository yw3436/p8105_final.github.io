...
The unemployment rate decreases over time from 2011 to 2019 for Bronx (Bronx County), Brooklyn (Kings County), Manhattan (New York County), Queens (Queens County), Staten Island (Richmond County).
...
Overall, the smooth line indicates an increasing trend of number of HIV diagnoses when unemployment rate increases. 